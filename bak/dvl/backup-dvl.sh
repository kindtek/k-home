...
# HEL_RESTORE_SCRIPT="$backup_mnt_location/${username}/restore-dvl-$WSL_DISTRO_NAME.sh"
...
echo 'restoring $_NIX_MNT_LOCATION/${username}/dvl-$WSL_DISTRO_NAME/dvl to /home ...'
cp --backup=$VERSION_CONTROL --remove-destination -arfv $_NIX_MNT_LOCATION/${username}/dvl-$WSL_DISTRO_NAME/dvl /home" > $HEL_RESTORE_SCRIPT
