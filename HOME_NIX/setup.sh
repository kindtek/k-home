...
if [ "${convert_net,,}"  = "y" ] || [ "${convert_net,,}" = "yes" ]; then
    ...
    pwsh.exe -ExecutionPolicy RemoteSigned -file "${HOME}/dvlw/dvlp/mnt/HOME_NIX/bridge-wsl2-net.ps1" || powershell.exe -ExecutionPolicy RemoteSigned -file "${HOME}/dvlw/dvlp/mnt/HOME_NIX/bridge-wsl2-net.ps1" || pwsh -ExecutionPolicy RemoteSigned -file "${HOME}/dvlw/dvlp/mnt/HOME_NIX/bridge-wsl2-net.ps1" || echo "
------------------------------- copy_start -------------------------------
